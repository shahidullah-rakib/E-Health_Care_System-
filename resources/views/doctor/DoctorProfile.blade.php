          ...
          <form action="">
            <table class="tbl-80">
                    <tr>
                        ...
                        <img src="{{asset('upload/'.session('image'))}}" height="200px" weidth="200px" alt=""><br>
                       </td>
                    </tr>
                    ...
                    <tr>
                        <td>
                        <a href="{{route('doctorChangePass', ['id' => $user->id])}}" class="btn-secondary">Change Password</a>
                        <a href="{{route('doctorUpdateInformation', ['id' => $user->id])}}" class="btn-secondary">Update Information</a>  <br><br>
                        <a href="{{route('doctorCheckSalary', ['id' => $user->id])}}" class="btn-secondary">Check Salary</a>                       
                        </td>
                    </tr>
