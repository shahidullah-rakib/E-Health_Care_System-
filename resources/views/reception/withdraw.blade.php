...
h1 {
  font-size: 80px;
	...
	<form method="post" action="/reception/discount">
						...
						<tr height="600px">
							...
							<td>
                             ...
                             <table align="center" border="1">
                                 <tr>
                                <td>
                                    <a href="/reception/withdraw/ncc">
                                    <img src="{{asset('upload/ncc.jpg')}}" align="center" style="width: 120px; height: 120px;"/><br/>
                                    
                                </td>
                                <td>
                                    <a href="/reception/withdraw/bkash">
                                    <img src="{{asset('upload/bkash.png')}}" align="center" style="width: 120px; height: 120px;"/><br/>
                                    
                                </td>
                                <td>
                                    <a href="/reception/withdraw/dbbl">
                                    <img src="{{asset('upload/dbbl.png')}}" align="center" style="width: 120px; height: 120px;"/><br/>
