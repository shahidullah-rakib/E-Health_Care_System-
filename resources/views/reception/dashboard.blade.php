						...
						<tr height="80px">
						 	...
						 	<td colspan="2">
						 		<div>
						 			...
						 			<span style="float: right;"> Logged in as <a style="color: black;" href="dashboard.php"></a> | <a href="/logout" style="color: blue">Logout</a> </span>
						 		</div>
						...
						<tr height="600px">
							<td >
								...
								<h2>
									...
									*<a href="/reception/searchdoctor" style="color: rgb(1, 18, 92);">Search Doctor</a><br/>
							...
							<td>
								<img src="../assets/img.png" align="center" style="width: 120px; height: 120px;"/><br/>
								<h1  style="color: rgb(245, 210, 15);"><b>Welcome  </b></h1>
							</td>
