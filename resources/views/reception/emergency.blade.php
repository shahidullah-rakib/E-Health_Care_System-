						...
						<tr height="600px">
                            ...
                            <table border="1">
					            <tr>
                                    ...
                                    <td> <input type="text" name="emr" value="{{$val->emergency}}"> </td>
				                </tr>
                        
					            <tr>
						            <td> Ambulance </td>
                                    <td> <input type="text" name="amb" value="{{$val->ambulance}}"> </td>
				                </tr>
							...
							@endforeach
							  <input type="submit" style="background-color: green" name="edit"  value="Update">
