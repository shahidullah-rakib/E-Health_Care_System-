						...
						<tr height="600px">
							<td >
								...
								<h2>
									...
									*<a href="sel.html" style="color: rgb(1, 18, 92);">Patient Bill</a><br/>
									*<a href="sel.html" style="color: rgb(1, 18, 92);">Rooms</a><br/>
									*<a href="sel.html" style="color: rgb(1, 18, 92);">Emergency</a><br/>
									*<a href="sel.html" style="color: rgb(1, 18, 92);">Patient Discount</a><br/>
							...
							<td>
								<fieldset style="width: 650px;height: 250px; text-align: center;margin: auto;background-color: rgb(141, 81, 95);">
					                <legend><h2><b><i> Admin ChatBox</i></b></h2></legend>
						                <div>
