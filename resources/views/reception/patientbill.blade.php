					...
					<table border="1" width="100%" >
						...
						<tr height="600px">
                            ...
                            <table border="1" align="center">
                                <tr>
                                    <td colspan="5">
                                    <a href="/reception/createbill" > 
                                        <input type="button" style="background-color: green" name="submit" value="Create Bill">
                                    </a>
                                    </td>
                                </tr>
					            <tr>
                        ...
                        @endforeach
					            <tr>
						            <td> <input type="text" name="name" value="{{$bill->name}}"></td>
                                    <td><input type="text" name="token" value="{{$bill->token}}"></td>
                                    <td><input type="text" name="tbill" value="{{$bill->total_bill}}"></td>
                                    <td><input type="text" name="pbill" value="{{$bill->paid_bill}}"></td>
                                    <td><input type="text" name="dbill" value="{{$bill->due_bill}}"></td>
