...
<body>
	<style>
body {
  background-image: {{asset('images/x.jpg')}};
					...
					<table border="1" width="100%" >
						<tr height="80px">
						 	...
						 	<td colspan="2"  style="background-color: rgb(67, 65, 33)">
						 		<div >
						 			...
						 			<span style="float: right;"> Logged in as <a style="color: green;" href="/reception/dashboard">{{$username}}</a> | <a href="/reception/logout" style="color: blue">Logout</a> </span>
						 		</div>
						...
						<tr height="600px">
							...
							<td>
								...
								<h1  style="color: rgb(245, 210, 15);"><b>Welcome {{$name}}</b></h1>
							</td>
