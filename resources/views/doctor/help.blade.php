  ...
  <body>
    ...
    <div class="admin-wrapper">
      ...
      <div class="admin-content">
        <div class="content">
          <h2 class="">Doctor Information </h2>
          <form action="" method="post">

            @foreach ($doctor_sche as $doctor_sche)
              <div class="col-4">
                <b>Doctor Name : </b> {{$doctor_sche->name}} <br>
                <b>Email Address : </b> {{$doctor_sche->email}} <br>
                <b>Speciality : </b> {{$doctor_sche->speciality}}  <br>
                <b>Time  : </b> {{$doctor_sche->available}}  <br>
                <b>Fee : </b> {{$doctor_sche->fee}}  <br>
