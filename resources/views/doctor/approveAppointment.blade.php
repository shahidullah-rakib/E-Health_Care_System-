  ...
  <body>
    ...
    <div class="admin-wrapper">
      ...
      <div class="admin-content">
        <div class="content">
          <h2 class="">Aprove Apiroment</h2><br>
          <a href="{{route('newApiroment', ['id' => $user->id])}}" class="btn-secondary">New Apiroment</a>
          <br><br>

        
        <form action="" method="post">

          @foreach ($panding as $panding)
            <div class="col-4">
              <b>Patient Name : </b> {{$panding->patient_name}} <br>
              <b>Set Time  </><input type="text" name="date" value="{{$panding->date}}"> <br><br>
