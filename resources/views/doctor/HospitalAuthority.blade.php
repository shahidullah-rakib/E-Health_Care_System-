  ...
  <body>
    ...
    <div class="admin-wrapper">
      ...
      <div class="admin-content">
        <div class="content">
          <h2 class="">Assign Receptionist</h2>
          <form action="" method="post">

          @foreach ($receptionist as $receptionist)
            <div class="col-4">
              <b>Receptionist Name : </b> {{$receptionist->name}} <br>
              <b>Duties Time : </b> {{$receptionist->dutiesTime}} <br>
              <b>Contact Info : </b> {{$receptionist->email}} or {{$receptionist->phone}} <br>
