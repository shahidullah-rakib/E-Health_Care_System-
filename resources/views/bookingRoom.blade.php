...
<div class="container-1">
        ...
        <div class="content">
            <div class="container"
                style="background-color: white;max-height:600px; margin-left: 200px; max-width: 600px; padding: 20px; margin-top: 50px;">
                <h2>Room Book</h2>
                <form action="" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="Room No.." class="form-control input">
                    </div>
                    <div class="form-group">
                        <label for="name" class="label">Seat</label>
                        <input type="text" placeholder="seat.." name="seat" class="form-control input">
                    </div>
                    <div class="form-group">
                        <label for="name" class="label">Price</label>
                        <input type="text" placeholder="Price" name="Price" class="form-control input">
                    </div>
                    <div class="form-group">
                        <label for="name" class="label">Patinet name</label>
                        <input type="text" placeholder="Patient name.." name="username" class="form-control input">
                    </div>
                    <div class="form-group">
                        <label for="name" class="label">Phone No</label>
                        <input type="text" placeholder="Phone No.." name="phoneNo" class="form-control input">
                    </div>
