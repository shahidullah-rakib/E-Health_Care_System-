					...
					<table border="1" width="100%" >
						...
						<tr height="600px">
                            ...
                            <table border="1" align="center">
					            ...
					            <tr>
						            <td> <input type="text" name="rno" value="{{$val->roomNo}}"> </td>
                                    <td><input type="text" name="rtype" value="{{$val->roomType}}"></td>
                                    <td><input type="text" name="rprice" value="{{$val->price}}"></td>
                                    <td><input type="text" name="rst" value="{{$val->status}}"></td>
